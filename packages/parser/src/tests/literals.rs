...
#[test]
fn identifier() {
	let ast = parser::ExpressionParser::new().parse("myVariable").unwrap();
	match *ast {
...
#[test]
fn boolean_true() {
	let ast = parser::ExpressionParser::new().parse("true").unwrap();
	match *ast {
...
#[test]
fn boolean_false() {
	let ast = parser::ExpressionParser::new().parse("false").unwrap();
	match *ast {
...
#[test]
fn string() {
	let ast = parser::ExpressionParser::new().parse("\"hello\"").unwrap();
	match *ast {
