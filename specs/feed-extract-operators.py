# The feed and extract operators (<< and >>) are similar to the C++ ones
# They can be used with streams, generators, and any type with a notion of "feeding" or "extracting", like FIFO
...
# ie a feed and an extract methods


# -- Another use case of the feed and extract operators would be object assignment
# Object assignment is a very important part of the Fa language
objA << objB  # we feed objA with objB
...
hercule >> ajax  # feed ajax with hercule
...
# containers all overload this operator (since their properties are not so important to exchange)
let arrayA = [5, 12, 3]
let arrayB = [8, 9]
